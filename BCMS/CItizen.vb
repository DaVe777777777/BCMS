...
Public Class Citizen
    ...
    Private Sub Citizen_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub LoadCitizenData(Optional searchTerm As String = "")
